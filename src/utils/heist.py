...
class EnvState:
    ...
    def set_entity_position(self, entity_type, entity_theme, x, y, skip_hud=True):
        """
        Set entity position. By default skips HUD keys to preserve them.
        
        Args:
            entity_type: Type of entity (e.g., 2 for KEY)
